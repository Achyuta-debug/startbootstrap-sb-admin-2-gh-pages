                                        ...
                                        <div class="text-primary">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="inputState" class="form-control" name="sid">
                                                        <option selected><?php  echo $sid?></option>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text"  class="form-control"
                                                           id="servicename" value="<?php echo $sname?>" name="sname" required>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="serviceprice">Service price</label>
                                                    <input type="number" max="5000" class="form-control"
                                                           id="serviceprice" value="<?php echo $sprice?>"name="sprice" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="text-center">
                                                <input type="submit" value="Update"
                                                       name="Update-ser" class="btn btn-primary col-sm-3 btn-user ">
                                            </div>
                                        </div>
                                    </form>
                                </div>
